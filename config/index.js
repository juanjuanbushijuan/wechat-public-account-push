export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxd7858a9b297c9667",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "31e7e10b27c9aa495d1abee5bdfba5be",
  ...
  USERS: [
    {
      ...
      id: "_NQd7AkwOVDsQJZqA38VAR0oWMGtn00pDdbDfVSOfNA",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "",
      // 所在省份
      province: "山西",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "大大大大大宝贝", "year": "2003", "date": "05-16"},
